...
import type { HighlightKind } from "../lib/highlights";
...
/**
 * One card in the tree canvas. The "highlight" prop carries the overlay
 * state computed by `TreeCanvas` from the active run.
 */
export function TreeNode({ data, selected }: NodeProps) {
  ...
  return (
    ...
    >
      ...
      <div className="mt-0.5 text-[10px] opacity-60 truncate leading-tight">
        {description}
      </div>
      <Handle
        type="source"
